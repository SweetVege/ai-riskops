import { analyticsFilterResponse, analyticsFiltersFromSearchParams, analyticsSummary, loadAnalyticsDataset } from "@/lib/api/analytics";
...
export async function GET(request: Request) {
  ...
  return apiOk({
    ...
    data: analyticsSummary(riskEvents, callLogs),
  });
}
